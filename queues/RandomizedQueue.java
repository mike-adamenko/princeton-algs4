...
public class RandomizedQueue<Item> implements Iterable<Item> {
     ...
     */
    public Item dequeue() {
        if (isEmpty()) throw new NoSuchElementException("Cannot dequeue from an empty RandomizedQueue");
     ...
     */
    public Item sample() {
        if (isEmpty()) throw new NoSuchElementException("Cannot sample an empty RandomizedQueue");
